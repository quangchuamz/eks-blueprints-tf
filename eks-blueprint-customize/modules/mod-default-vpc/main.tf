...
resource "aws_default_security_group" "this" {
  //count = data.aws_vpc.this.id != "" && var.manage_default_security_group ? 1 : 0
...
resource "aws_default_network_acl" "this" {
  //count = data.aws_vpc.this.id != "" && var.manage_default_network_acl ? 1 : 0
...
resource "aws_default_route_table" "default" {
  //count = data.aws_vpc.this.id != "" && var.manage_default_route_table ? 1 : 0
